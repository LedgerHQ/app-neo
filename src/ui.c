...
// },
		...
		/* center text */
		{	{	BAGL_LABELINE, 0x02, 0, 12, 128, 11, 0, 0, 0, 0xFFFFFF, 0x000000, DEFAULT_FONT, 0 }, "Wake Up, NEO..." },
		/* left icon is a X */
...
// },
		...
		{	{	BAGL_LABELINE, 0x02, 10, 10, 108, 11, 0x80 | 10, 0, 0, 0xFFFFFF, 0x000000, TX_DESC_FONT, 0 }, address58[0] },
		/* second line of description of current public key */
		{	{	BAGL_LABELINE, 0x02, 10, 21, 108, 11, 0x80 | 10, 0, 0, 0xFFFFFF, 0x000000, TX_DESC_FONT, 0 }, address58[1] },
		/* right icon is a X */
...
// },
		{	{	BAGL_RECTANGLE, 0x00, 0, 0, 128, 32, 0, 0, BAGL_FILL, 0x000000, 0xFFFFFF, 0, 0 }, NULL },
		/* second line of description of current public key */
		{	{	BAGL_LABELINE, 0x02, 10, 10, 108, 11, 0x80 | 10, 0, 0, 0xFFFFFF, 0x000000, TX_DESC_FONT, 0 }, address58[1] },
		/* third line of description of current public key  */
		{	{	BAGL_LABELINE, 0x02, 10, 21, 108, 11, 0x80 | 10, 0, 0, 0xFFFFFF, 0x000000, TX_DESC_FONT, 0 }, address58[2] },
		/* right icon is a X */
		{	{	BAGL_ICON, 0x00, 113, 12, 7, 7, 0, 0, 0, 0xFFFFFF, 0x000000, 0, BAGL_GLYPH_ICON_CROSS }, NULL },
...
static void displayAddress(void) {
    ...
    .centeredInfo.icon = &C_wallet_64px,
...
static void rejectUseCaseChoice(void)
{
    nbgl_useCaseConfirm("Reject transaction?",NULL,"Yes, Reject","Go back to transaction",rejectConfirm);
}
...
static void reviewStart(void)
{
    ...
    nbgl_useCaseReviewStart(&C_icon_64px, "Review transaction", NULL,
        "Reject transaction", displayTransaction, rejectUseCaseChoice);
}
#endif
////////////////////////////////////////////////////////////////////////////////////////////////
...
#elif defined(TARGET_STAX)
    nbgl_useCaseHomeExt("Neo",&C_icon_64px, NULL, false, "Display account",displayAddress,displayInfoMenu,onQuitCallback);
#endif // #if TARGET_ID
}
